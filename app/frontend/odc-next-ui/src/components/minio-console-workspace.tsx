...
// The MinIO web console. Defaults to the public Cloudflare-tunneled domain so
// the iframe embeds cleanly (the X-Frame-Options header is stripped at the
// Cloudflare edge via a Response Header Transform rule). Override with
// NEXT_PUBLIC_MINIO_CONSOLE_URL for localhost or another host.
const CONSOLE_URL =
  process.env.NEXT_PUBLIC_MINIO_CONSOLE_URL ?? "https://minio.luumtran.dev";

export function MinioConsoleWorkspace() {
